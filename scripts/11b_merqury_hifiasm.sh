...
#SBATCH --job-name=merqury_hifiasm
...
OUTDIR='/data/users/jvaleriano/assembly_course/asm_evaluation/merqury/hifiasm'
ASSEMBLY='/data/users/jvaleriano/assembly_course/assemblies/hifiasm/hifiasm.fa'
...
merqury.sh $MERYL_DB $ASSEMBLY mq
