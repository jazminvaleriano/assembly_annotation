...
OUTDIR='/data/users/jvaleriano/assembly_course/asm_evaluation/merqury/LJA'
ASSEMBLY='/data/users/jvaleriano/assembly_course/assemblies/lja/lja_assembly.fasta'
